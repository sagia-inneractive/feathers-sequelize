...
class Service extends AdapterService {
  ...
  _create (data, params = {}) {
    ...
    const createOptions = this.mutateOptions(Object.assign({
      returning: true
  ...
  _patch (id, data, params = {}) {
    ...
    return ids.then(idList => {
      ...
      const seqOptions = this.mutateOptions(Object.assign(
        { raw: this.raw },
        params.sequelize,
  ...
  _update (id, data, params = {}) {
    ...
    // update
    const seqOptions = this.mutateOptions(Object.assign({}, params.sequelize, { raw: false }), "_update");
  ...
  _remove (id, params = {}) {
    ...
    const options = this.mutateOptions(Object.assign({}, { where }, params.sequelize), "_remove");
