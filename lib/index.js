...
class Service extends AdapterService {
  ...
  _create (data, params = {}) {
    ...
    const createOptions = this.mutateOptions(params, Object.assign({
      returning: true
    }, options, { raw: ignoreSetters }), "_create");
  ...
  _patch (id, data, params = {}) {
    ...
    return ids.then(idList => {
      ...
      const seqOptions = this.mutateOptions(params, Object.assign(
        { raw: this.raw },
        params.sequelize,
  ...
  _update (id, data, params = {}) {
    ...
    return this._get(id, { sequelize: seqOptions, query: where }).then(instance => {
      ...
      return instance.update(copy, this.mutateOptions(params, seqOptions, "_update"))
        .then(() => this._get(id, {
  ...
  _remove (id, params = {}) {
    ...
    const options = this.mutateOptions(params, Object.assign({}, { where }, params.sequelize), "_remove");
  ...
  mutateOptions(params = {}, options = {}, name = "") {
    return options;
  }
